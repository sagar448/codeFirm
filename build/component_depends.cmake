...
function(get_component_requirements component var_requires var_private_requires)
  ...
  if("${component}" STREQUAL "main")
    set(${var_requires} "BME680;OmronD6T;app_trace;app_update;asio;aws_iot;bootloader;bootloader_support;bsec;bt;coap;console;cxx;driver;ds18b20;efuse;esp-aws-iot;esp-tls;esp32;esp8266_wrapper;esp_adc_cal;esp_event;esp_http_client;esp_http_server;esp_https_ota;esp_https_server;esp_ringbuf;espcoredump;esptool_py;ethernet;expat;fatfs;freemodbus;freertos;heap;idf_test;jsmn;json;libsodium;log;lwip;mbedtls;mdns;micro-ecc;mqtt;newlib;nghttp;nvs_flash;openssl;partition_table;protobuf-c;protocomm;pthread;sdmmc;smartconfig_ack;soc;spi_flash;spiffs;tcp_transport;tcpip_adapter;tcs34725;ulp;unity;vfs;wear_levelling;wifi_provisioning;wpa_supplicant;xtensa-debug-module" PARENT_SCOPE)
    set(${var_private_requires} "" PARENT_SCOPE)
    return()
  endif()
